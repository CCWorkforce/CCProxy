...
class TestModelSelection:
    ...
    def test_opus_model_selects_big_model(self):
    ...
    def test_sonnet_model_selects_big_model(self):
    ...
    def test_haiku_model_selects_small_model(self):
    ...
    def test_unknown_model_defaults_to_small_model(self):
    ...
    def test_different_big_model_name(self):
    ...
    def test_different_small_model_name(self):
