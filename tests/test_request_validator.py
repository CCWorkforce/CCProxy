...
class TestRequestValidator:
    ...
    def test_cache_hit_on_duplicate_request(self):
    ...
    def test_different_requests_cache_separately(self):
    ...
    def test_request_hash_different_for_different_requests(self):
    ...
    def test_request_hash_same_for_reordered_keys(self):
    ...
    def test_validation_error_not_cached(self):
    ...
    def test_complex_request_validation(self):
    ...
    def test_cache_with_streaming_parameter(self):
